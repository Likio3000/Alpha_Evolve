...
Paper update TODO: refresh the research paper write-up to document the newer
evolution/backtest changes and the latest compute-scaling, correlation, and
ensemble performance results generated by the current benchmark workflow.
