...
Latest research update (February 15, 2026):

- `docs/reference/research-paper-addendum-2026-02-15.md` documents the newest
  matched-seed scientific findings, including:
  - significant `g200 > g60` gains for ensemble Sharpe/return and lower
    pairwise correlation, and
  - the current `v4` plateau-strategy A/B result (not yet superior to `v3`).
