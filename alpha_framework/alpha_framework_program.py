...
import json
import textwrap
from typing import Dict, List, Literal, Optional, Union  # Added Callable for OpSpec
import numpy as np
...
class AlphaProgram:
    ...
    def random_program(
        ...
        return generate_random_program_logic(
            cls, feature_vars, state_vars, max_total_ops, rng
        )
    ...
    def crossover(
        self, other: "AlphaProgram", rng: Optional[np.random.Generator] = None
    ) -> "AlphaProgram":
