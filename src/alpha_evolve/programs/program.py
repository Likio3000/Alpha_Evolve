...
from . import logic_generation as program_logic_generation
from .logic_generation import generate_random_program_logic
from .logic_variation import mutate_program_logic, crossover_program_logic
