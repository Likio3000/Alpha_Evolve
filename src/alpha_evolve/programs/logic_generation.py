...
# Import necessary modules for program logic generation
from .ops import Op
from .types import TypeId, OP_REGISTRY, FINAL_PREDICTION_VECTOR_NAME
...
if TYPE_CHECKING:
    from .program import AlphaProgram  # For type hint of cls and return type
