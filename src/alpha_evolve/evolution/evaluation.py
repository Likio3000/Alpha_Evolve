...
if TYPE_CHECKING:
    ...
    from alpha_evolve.programs.ops import Op  # For _uses_feature_vector
    from alpha_evolve.evolution import data as data_handling  # To access data
    from alpha_evolve.evolution import hall_of_fame as hof_manager  # To get HOF penalty
